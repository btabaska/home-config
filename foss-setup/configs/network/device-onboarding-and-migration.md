# Device → Subnet Assignment, IoT Onboarding & Fleet Migration Helper — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/network/device-onboarding.md` → <https://wiki.tabaska.us/reference/network/device-onboarding/>
