# UniFi ZBF — Firewall Policy Walkthrough (net-05) — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/network/firewall-walkthrough.md` → <https://wiki.tabaska.us/reference/network/firewall-walkthrough/>
