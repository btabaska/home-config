# DNS resilience plan — fail-open, not fail-closed — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/network/dns-resilience.md` → <https://wiki.tabaska.us/reference/network/dns-resilience/>
