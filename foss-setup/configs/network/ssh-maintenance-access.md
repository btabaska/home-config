# SSH & maintenance access — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/network/ssh-access.md` → <https://wiki.tabaska.us/reference/network/ssh-access/>
