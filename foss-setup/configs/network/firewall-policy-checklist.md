# UniFi ZBF — Firewall Policy Checklist (net-05)

Tick-box guide for creating policies on the Dream Wall.

**Open:** Settings → Zones → **Create Policy** (or Policy Table → Create New Policy)

Related: [firewall-policy-order.md](firewall-policy-order.md) ·
[firewall-policy-walkthrough.md](firewall-policy-walkthrough.md) ·
[vlan-zone-firewall-plan.md](vlan-zone-firewall-plan.md)
...
| **Source Port** | Any |
| **Action** | **Block** |
| **Auto allow return traffic** | **unchecked** |
| **Destination Zone** | **External** |
| **Destination** | Any |
| **Destination Port** | Any |
| **IP Version** | Both |
...
ZONE=iot TRUSTED_IP=192.168.10.1 ./scripts/network/zbf-isolation-verify.sh
```
