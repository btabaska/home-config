# UniFi Dream Wall — VLAN / Zone / Firewall Plan — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/network/vlan-zone-firewall.md` → <https://wiki.tabaska.us/reference/network/vlan-zone-firewall/>
