# Game Server Research Guide — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/gaming/server-guide.md` → <https://wiki.tabaska.us/reference/gaming/server-guide/>
