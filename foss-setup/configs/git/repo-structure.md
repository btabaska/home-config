# Config-as-code: repo structure, branching & secrets — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/operations/repo-structure.md` → <https://wiki.tabaska.us/operations/repo-structure/>
