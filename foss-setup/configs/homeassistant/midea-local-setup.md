# Midea AC + Dehumidifier — Local Control in Home Assistant — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/home-assistant/midea-local.md` → <https://wiki.tabaska.us/reference/home-assistant/midea-local/>
