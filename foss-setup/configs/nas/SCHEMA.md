# NAS Storage Schema (DS920+) — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/nas/volume-schema.md` → <https://wiki.tabaska.us/reference/nas/volume-schema/>
