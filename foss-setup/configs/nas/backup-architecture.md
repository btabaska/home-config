# Homelab Backup Architecture (3-2-1) — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/nas/backup-architecture.md` → <https://wiki.tabaska.us/reference/nas/backup-architecture/>
