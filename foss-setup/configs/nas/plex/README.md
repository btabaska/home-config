# Plex Media Server on the DS920+ (Synology) — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/nas/plex.md` → <https://wiki.tabaska.us/reference/nas/plex/>
