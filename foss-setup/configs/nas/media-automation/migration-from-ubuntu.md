# Migrating *arr configs from Ubuntu (Mac mini) to NAS — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/reference/nas/media-automation-migration.md` → <https://wiki.tabaska.us/reference/nas/media-automation-migration/>
