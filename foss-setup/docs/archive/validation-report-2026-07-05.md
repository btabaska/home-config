...
- **HTML:** `esc()` escapes quotes (copy buttons work), Forgejo `3030`/Miniflux `8082` port map, NUT NAS IP `192.168.10.4`, decimal-hour estimator, tab ARIA roles, ZBT-2 link, README `inventory/` dirs.
