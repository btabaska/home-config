...
- **Repo**: configs/gaming/amp/compose.yaml mirror updated (hostname pin, java envs, port maps; secrets stay ${AMP_*}); minecraft-crossplay-finish.md rewritten as live-state runbook; todo-guide TASK 02 marked done; progress.json game-02 → done (125/223).
