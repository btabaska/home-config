# Reading stack wiring — Calibre + CWA + KOReader (Kobo) + Wallabag + Syncthing — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/guides/koreader-cwa-wallabag.md` → <https://wiki.tabaska.us/guides/koreader-cwa-wallabag/>
