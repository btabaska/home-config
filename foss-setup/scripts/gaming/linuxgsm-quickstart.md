# LinuxGSM quickstart — light co-op servers on the Mac mini (Ubuntu) — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/guides/linuxgsm.md` → <https://wiki.tabaska.us/guides/linuxgsm/>
