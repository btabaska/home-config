# Apollo on the CachyOS rig — install, config & autostart runbook — moved to the wiki
...
**Now lives at:** `foss-setup/wiki/docs/guides/apollo-autostart.md` → <https://wiki.tabaska.us/guides/apollo-autostart/>
