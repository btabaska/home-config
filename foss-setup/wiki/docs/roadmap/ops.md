...
| `dns-06` | NAS AdGuard: external resolution failing (dns-nas-external crit) | ✅ done | 20-40 min |
...
| `fix-103` | Accepted benign residuals — log-noise, self-recovered transients, minor version-lag, game-server residuals | ✅ done | 1-3 hrs |
...
| `glue-15` | Clear the pre-existing fleet git-hygiene regressions surfaced during glue-14 | ✅ done | 30-45 min |
