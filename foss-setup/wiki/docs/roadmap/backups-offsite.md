...
|---|---|---|---|
| `fix-42` | Make off-site DR reproducible (ansible backup role is a no-op diverged from live) | ✅ done | 1-3 hrs |
| `fix-82` | B2 restic object-lock immutability decayed — restore true immutability (fix-22 regression) | ✅ done | 1-3 hrs |
| `fix-93` | Backup-set coverage gaps — service persistent data outside curated restic/Hyper-Backup sets + DR template drift | ⬜ open | 1-3 hrs |
