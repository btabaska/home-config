...
4 task(s). Status mirrors `docs/progress.json` (the source of truth).

| Task | Title | Status | Effort |
|---|---|---|---|
| `fix-35` | Immich: start real phone backups (empty library) + lock down the unused second admin | ✅ done | 1-3 hrs |
| `fix-60` | Immich cluster: nightly ffmpeg segfault on one corrupt .mov (5 nights), second household user has 0 photos ever, bogus 4501 date tops the timeline, pg-dumps unrotated | ✅ done | 1-3 hrs |
