...
**RETIRED 2026-09-10 (retire-gaming-02) — AMP + MinecraftCross01 stopped; world archived to amp-minecraftcross01-final-20260910.tar.gz (rig + NAS + B2); 30-day grace, deletion in retire-gaming-03, revival via compose up -d.**
...
| **Notes** | RETIRED 2026-09-10 (retire-gaming-02) — stopped; world archived to amp-minecraftcross01-final-20260910.tar.gz (rig + NAS + B2). 30-day grace, deletion in retire-gaming-03, revival via compose up -d. CubeCoders AMP game panel (MinecraftCross Java+Bedrock instance). Licence is hostname-pinned — never change the compose hostname casually. |

## About

> **RETIRED 2026-09-10 (retire-gaming-02, temporary).** AMP +
> MinecraftCross01 stopped; world archived to
> amp-minecraftcross01-final-20260910.tar.gz (rig + NAS + B2, sha256 in
> progress.json). Checks disabled; 30-day grace — deletion in
> retire-gaming-03, revival via `compose up -d`. Everything below
