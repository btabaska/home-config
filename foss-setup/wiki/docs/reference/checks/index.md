...
Every acceptance/regression check the fleet runs — **389 checks across 41 domains**, generated from `verification/checks.d/` by `scripts/docs/gen-checks-pages.py`. These probe OUTCOMES (does the user-visible result work), not just liveness. See the [Verification runbook](../../runbooks/verification.md) and [Acceptance-testing framework](../../runbooks/acceptance-testing.md).
...
| [journaling](journaling.md) | 13 | 3 | 10 |
| [lan-exposure](lan-exposure.md) | 4 | 0 | 4 |
| [local-ai](local-ai.md) | 22 | 0 | 22 |
