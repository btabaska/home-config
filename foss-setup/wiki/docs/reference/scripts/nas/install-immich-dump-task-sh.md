# `install-immich-dump-task.sh`

> _(no header summary)_

**Path:** `foss-setup/scripts/nas/install-immich-dump-task.sh` · **Category:** [NAS tasks](index.md) · **Type:** Bash

## What it does

_No header documentation in the script._
