...
11. **Paperless-ngx** for documents + **Mealie** for recipes. Keep **Bitwarden**. **Mealie ✅ live**; **Paperless-ngx planned, not yet deployed**; Vaultwarden data cutover is a tracked research task.
